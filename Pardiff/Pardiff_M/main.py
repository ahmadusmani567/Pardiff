...
one_hot = ToOneHot(info['num_node_features'], info['num_edge_features'],
...
wb_logger = None if cfg.eval_only else WandbLogger(project=f'ParallelDiffusion-{cfg.task}', name=full_name, config=cfg)
